...
#define S_FUNCTION_NAME solverTV_simulinkBlock
...
extern solver_int32_default solverTV_adtool2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 1 */
    ssSetInputPortMatrixDimensions(S,  1, 145, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 630, 1);
	...
	/* Output Port 1 */
    ssSetOutputPortMatrixDimensions(S,  1, 130, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T *zI = (real_T*) ssGetOutputPortSignal(S,0);
	real_T *z = (real_T*) ssGetOutputPortSignal(S,1);
	...
	params.solver_timeout = (solverTV_float) *solver_timeout;
    ...
    /* Call solver */
    solver_exitflag = solverTV_solve(&params, &output, &info, mem, fp , pt2function_solverTV);
