...
{
    public:
        PIDImpl( double dt, double Kp, double Kd, double Ki , double Klim);
        ~PIDImpl();
...
PID::PID( double dt, double Kp, double Kd, double Ki, double Klim )
{
    pimpl = new PIDImpl(dt,Kp,Kd,Ki,Klim);
}
 ...
 * Implementation
 */
PIDImpl::PIDImpl( double dt, double Kp, double Kd, double Ki, double Klim) :
    _dt(dt),
    _Kp(Kp),
    _Kd(Kd),
    _Ki(Ki),
