...
#include "solverMPCC/include/solverMPCC.h"
                                 ...
                                 solver_int32_default threadID   /* Id of caller thread                                */)
{
    ...
    solverMPCC_callback_float w[359];
    ...
    solverMPCC_callback_float h_sparse[3];
    solverMPCC_callback_float nabla_h_sparse[6];
    solverMPCC_callback_float c_sparse[14];
    solverMPCC_callback_float nabla_c_sparse[46];
	...
	if ((stage >= 49) && (stage < 50))
	{
		out[0] = &this_f;
		out[1] = nabla_f_sparse;
		solverMPCC_objective_50(in, out, NULL, w, 0);
		if (nabla_f != NULL)
		{
			nrow = solverMPCC_objective_50_sparsity_out(1)[0];
			ncol = solverMPCC_objective_50_sparsity_out(1)[1];
			colind = solverMPCC_objective_50_sparsity_out(1) + 2;
			row = solverMPCC_objective_50_sparsity_out(1) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, nabla_f_sparse, nabla_f);
		}

		out[0] = c_sparse;
		out[1] = nabla_c_sparse;
		solverMPCC_dynamics_50(in, out, NULL, w, 0);
		if (c != NULL)
		{
			nrow = solverMPCC_dynamics_50_sparsity_out(0)[0];
			ncol = solverMPCC_dynamics_50_sparsity_out(0)[1];
			colind = solverMPCC_dynamics_50_sparsity_out(0) + 2;
			row = solverMPCC_dynamics_50_sparsity_out(0) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, c_sparse, c);
		}

		if (nabla_c != NULL)
		{
			nrow = solverMPCC_dynamics_50_sparsity_out(1)[0];
			ncol = solverMPCC_dynamics_50_sparsity_out(1)[1];
			colind = solverMPCC_dynamics_50_sparsity_out(1) + 2;
			row = solverMPCC_dynamics_50_sparsity_out(1) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, nabla_c_sparse, nabla_c);
		}

		out[0] = h_sparse;
		out[1] = nabla_h_sparse;
		solverMPCC_inequalities_50(in, out, NULL, w, 0);
		if (h != NULL)
		{
			nrow = solverMPCC_inequalities_50_sparsity_out(0)[0];
			ncol = solverMPCC_inequalities_50_sparsity_out(0)[1];
			colind = solverMPCC_inequalities_50_sparsity_out(0) + 2;
			row = solverMPCC_inequalities_50_sparsity_out(0) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, h_sparse, h);
		}

		if (nabla_h != NULL)
		{
			nrow = solverMPCC_inequalities_50_sparsity_out(1)[0];
			ncol = solverMPCC_inequalities_50_sparsity_out(1)[1];
			colind = solverMPCC_inequalities_50_sparsity_out(1) + 2;
			row = solverMPCC_inequalities_50_sparsity_out(1) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, nabla_h_sparse, nabla_h);
		}
	...
	if ((stage >= 50) && (stage < 51))
	{
		out[0] = &this_f;
		out[1] = nabla_f_sparse;
		solverMPCC_objective_51(in, out, NULL, w, 0);
		if (nabla_f != NULL)
		{
			nrow = solverMPCC_objective_51_sparsity_out(1)[0];
			ncol = solverMPCC_objective_51_sparsity_out(1)[1];
			colind = solverMPCC_objective_51_sparsity_out(1) + 2;
			row = solverMPCC_objective_51_sparsity_out(1) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, nabla_f_sparse, nabla_f);
		}

		out[0] = h_sparse;
		out[1] = nabla_h_sparse;
		solverMPCC_inequalities_51(in, out, NULL, w, 0);
		if (h != NULL)
		{
			nrow = solverMPCC_inequalities_51_sparsity_out(0)[0];
			ncol = solverMPCC_inequalities_51_sparsity_out(0)[1];
			colind = solverMPCC_inequalities_51_sparsity_out(0) + 2;
			row = solverMPCC_inequalities_51_sparsity_out(0) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, h_sparse, h);
		}

		if (nabla_h != NULL)
		{
			nrow = solverMPCC_inequalities_51_sparsity_out(1)[0];
			ncol = solverMPCC_inequalities_51_sparsity_out(1)[1];
			colind = solverMPCC_inequalities_51_sparsity_out(1) + 2;
			row = solverMPCC_inequalities_51_sparsity_out(1) + 2 + (ncol + 1);
			solverMPCC_sparse2fullcopy(nrow, ncol, colind, row, nabla_h_sparse, nabla_h);
		}
