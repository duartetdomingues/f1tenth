...
% Soft Front track constraints
    ...
    diff_Coeffs = differentialCoeffs;
...
function dX = dynamic_bicycle_model(x,u,p)
    ...
    % Differential
    [diff_front, diff_rear] = differential(x(4),u(2),diff_gain);
...
function [diff_front, diff_rear] = differential(v_x,delta,diff_gain)
    global diff_Coeffs;
    ratio = 0.5;
    ...
    diff_front = diff_T*ratio/(1+ratio);
end
%% ----------- Exit Flags -----------------------------------------------
