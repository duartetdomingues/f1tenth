...
%     formulateMPCC_kamm_circle(matSpline, config_data, track_length, extended_distance,STORE_MEX_DATA); 
    formulateMPCC_yaw_cost(matSpline, config_data, track_length, extended_distance,STORE_MEX_DATA); 
end
...
%     x0iZ=[0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01]';
    ...
    x0iM=[0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01]';
...
%         problem.xinit = [output.z(2),output.z(3),output.zI(1),output.zI(2),output.z(7),output.z(8),output.z(9),output.z(10),output.z(11),output.z(12),output.z(13)]';
        problem.xinit = [output.z(1),output.z(2),output.zI(1),output.zI(2),output.zI(12),output.zI(13),output.zI(14),output.z(8),output.z(9),output.z(10),output.z(11),output.z(12),output.z(13),output.z(14)]';
        i = i + 1;
    end
