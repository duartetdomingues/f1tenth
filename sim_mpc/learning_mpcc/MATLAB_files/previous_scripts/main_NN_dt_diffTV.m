...
diffCoeffs.front = [71.0145, 0, 8.5638, 0];
diffCoeffs.rear = [32.9071, 0];
...
%     formulateMPCC_noNN_diffTV_dt(matSpline, config_data, track_length, extended_distance,STORE_MEX_DATA,diffCoeffs);
    formulateMPCC_NN_diffTV_dt(matSpline, config_data, track_length, extended_distance,STORE_MEX_DATA,diffCoeffs);
%     formulateMPCC_NN_diffTV_18_dt(matSpline, config_data, track_length, extended_distance,STORE_MEX_DATA,diffCoeffs);
%     formulateMPCC_NN_diffTV_23_dt(matSpline, config_data, track_length, extended_distance,STORE_MEX_DATA,diffCoeffs);
end
