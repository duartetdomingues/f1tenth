...
function h = ineqM(z,p)
    ...
    h = [
         (e_CL)-(dist_blue-width/2-safety_margin);         % track front blue (left)
         (e_CL)+(dist_yellow-width/2-safety_margin);       % track front yellow (right)
