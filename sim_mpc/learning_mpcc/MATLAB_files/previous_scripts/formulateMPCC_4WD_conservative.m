...
%     dySpline_FORCES =@(s) 0;
    ...
    car.downforce_front = config_data.model_params.downforce_front;
    car.downforce_rear = config_data.model_params.downforce_rear;
...
%     F_y = F_f*sin(u(2)) + Ff_y*cos_delta + Fr_y;
