...
% Soft Front track constraints
    ...
    %       51 - q_r_max
    %       52:end - NN_weights (1991 parameters in model 18)
...
function f = objectiveMiddle(z,p)
    ...
    f = q_r*(r/r_max)^2 + alpha_CL*e_CL^2 + alpha_L*e_L^2 + 1/integrator_stepsize*beta_steer*(steering-steering_prev)^2 + 1/integrator_stepsize*beta_throttle*(throttle-throttle_prev)^2 + exp(q_v_max*(vel-v_max)) - lambda*vk*integrator_stepsize;
end
% End
