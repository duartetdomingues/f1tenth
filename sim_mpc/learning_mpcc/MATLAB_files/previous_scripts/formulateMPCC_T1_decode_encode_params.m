...
% Soft Front track constraints
    ...
    model.npar = config_data.mpc_params.objective.p + config_data.mpc_params.objective.NN_params;
    ...
    %       51:end - NN_weights (1975 parameters in model 14)
