...
function f = objectiveMiddle(z,p)
    ...
    f = q_r*z(12)^2 + alpha_CL*e_CL^e_CL_exp + alpha_L*e_L^2 + beta_steer*(z(2)-z(4))^2 + beta_throttle*(z(1)-z(3))^2 + exp(q_v_max*(z(10)-v_max)) - lambda*vk*integrator_stepsize;
end
% End
function f = objectiveLast(z,p)
    ...
    f = q_r*z(8)^2 + alpha_CL*e_CL^e_CL_exp + alpha_L*e_L^2 + exp(q_v_max*(z(6)-v_max)) - lambda*vk*integrator_stepsize;
end
