...
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - matrix of size [859x1]
       PARAMS['xinit'] - matrix of size [14x1]
       PARAMS['all_parameters'] - matrix of size [21471x1]
       PARAMS['solver_timeout'] - scalar
       PARAMS['num_of_threads'] - scalar

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['z'] - column vector of length 833
       OUTPUT['zN_1'] - column vector of length 15
       OUTPUT['zN'] - column vector of length 11
...
#    def from_param(self):
#        return self
    _fields_ = [('x0', ctypes.c_double * 859),
('xinit', ctypes.c_double * 14),
('all_parameters', ctypes.c_double * 21471),
('solver_timeout', ctypes.c_double),
('num_of_threads', ctypes.c_uint),
]

solverMPCC_params = {'x0' : np.array([]),
'xinit' : np.array([]),
...
solverMPCC_params_types = {'x0' : np.float64,
'xinit' : np.float64,
...
#    def from_param(self):
#        return self
    _fields_ = [('z', ctypes.c_double * 833),
('zN_1', ctypes.c_double * 15),
('zN', ctypes.c_double * 11),
]
