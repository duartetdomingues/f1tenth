...
#define S_FUNCTION_NAME solverMPCC_simulinkBlockcompact
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 859, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	params.solver_timeout = (solverMPCC_float) solver_timeout[0];
	...
	for(i = 0; i < 15; i++)
	{
		outputs[833 + i] = (real_T) output.zN_1[i];
	}

	for(i = 0; i < 11; i++)
	{
		outputs[848 + i] = (real_T) output.zN[i];
	}
