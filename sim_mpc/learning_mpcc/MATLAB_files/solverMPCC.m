% solverMPCC - a fast solver generated by FORCESPRO v6.3.0
%
%   OUTPUT = solverMPCC(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = solverMPCC(PARAMS) returns additionally
...
%
%   [OUTPUT, EXITFLAG, INFO] = solverMPCC(PARAMS) returns 
