...
function dX = dynamic_bicycle_model(x,u,p)
    ...
    M_z = (F_f*sin(u(2)) + Ff_tire*cos(u(2)))*l_f - Fr_tire*l_r + diff_Mz + track_width/2*((Fy_fl-Fy_fr)*sin(u(2)) + (Fx_fr-Fx_fl)*cos(u(2)) + (Fx_rr-Fx_rl));
