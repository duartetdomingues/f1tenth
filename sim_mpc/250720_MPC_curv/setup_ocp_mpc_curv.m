function solver = setup_ocp_mpc_curv(N, Ds, R, track)

    import casadi.*

    [model , constraints] = car_model_mpc_curv(Ds, R, track);
    ...
    ocp.constraints.x0 =ones(8,1)* 1e-3;
