...
sour        error('env.sh has not been sourced! Before executing this example, run: source env.sh');
    end
    ...
    if ~is_casadi_available
        ...
        if strcmpi( In, 'n')
            ...
            elseif ismac
                ...
                disp(['trying to download and unpack: ', url,filename, ' to ',destination])
